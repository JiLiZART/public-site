  ...
  <section class="index-page" itemprop="author" itemscope itemtype="http://schema.org/Person">
    <header role="banner" tabindex="1">
      ...
      <page-description>
        ...
        <page-link href="https://www.ultimate-guitar.com/" aria-label="Компания Ultimate Guitar">
          Ultimate Guitar
        </page-link>
        ...
        <page-link href="https://skillsbord.com/" aria-label="Проект Skillsbord">
          Skillsbord
        </page-link>
        <span aria-hidden="true">
          🦄
        ...
        <span class="page__text page__text_gray page__text_small">
          Раньше проходил стажировку в <page-link href="https://skyeng.ru/" aria-label="Skyeng">
            Skyeng
          </page-link> 👷,
          проектировал SPA в <page-link href="https://www.medialooks.com" aria-label="Medialooks">
            Medialooks
          </page-link> 👨‍🏫 и
          создавал сложные интерфейсы в <page-link href="http://edster.ru" aria-label="Edster">
            Edster
          </page-link> 👨‍💻
        </span>
      </page-description>
    ...
    <main class="main" role="main">
      <article tabindex="2">
        ...
        <techs-logos class="index-page__techs" />
        <ul class="list list_bullets" aria-label="Список ключевых слов технологий" role="list">
          ...
          <li class="list__item" itemprop="keywords" role="listitem">
            ...
            <page-link href="http://jsonapi.org/">
              jsonapi
            </page-link>
            стандарт используя
            <page-link href="http://json-schema.org/">
              json schema
            </page-link>
            и
            <page-link href="https://jwt.io/">
              JWT
            </page-link>
          </li>
          <li class="list__item" itemprop="keywords" role="listitem">
        ...
        <ul class="list" aria-label="Список книг которые читаю" role="list">
          ...
          <li class="list__item" role="listitem">
            ...
            <page-link
              ...
              href="https://www.ozon.ru/context/detail/id/18322266/"
            >
              <s>
                The
                Lean Startup
          ...
          <li class="list__item" role="listitem">
            ...
            <page-link aria-label="Профиль на Codewars" href="https://www.codewars.com/users/JiLiZART">
              Codewars <span
              class="badge"
              :style="badgeStyle"
            ...
            <br>
            и
            <page-link aria-label="Профиль на Hackerrank" href="https://www.hackerrank.com/JiLiZART">
              Hackerrank
            </page-link>
      ...
      <article tabindex="4">
        ...
        <ul class="list projects" role="list" aria-label="Список проектов на Гитхабе">
          <li v-for="item in githubProjects" class="list__item projects__item" role="listitem">
            <github-favicon class="projects__item-icon" aria-hidden="true" />
            <page-link class="projects__item-link" :href="item.url">
              {{ item.title }}
            </page-link>
            <span class="projects__item-text" v-html="' — ' + item.text" />
          </li>
        </ul>
      </article>
      <article tabindex="5">
        ...
        <ul class="list articles" role="list" aria-label="Список статей на Хабре">
          <li v-for="item in habrArticles" class="list__item articles__item" role="listitem">
            <habr-favicon class="articles__item-icon" aria-hidden="true" />
